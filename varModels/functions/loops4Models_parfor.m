        ...
        for i = 1 : length(trials)
            ...
            if ~flag_modelScaled
                [path2Model, torsionTool, tf_angle_fromSource_right, ...
					...
					useASTool, useDirectKinematics4TibRotEstimationAsFallback, useStatic4FrontAlignmentAsFallback, tibTorsionAdaptionMethod, InputData, pelvisWidthGenericModel, scalePelvisManually);
